...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260614065302_AddOperationDocuments') THEN

    CREATE TABLE `OperationDocuments` (
        `Id` int NOT NULL AUTO_INCREMENT,
        `DocumentType` varchar(100) CHARACTER SET utf8mb4 NOT NULL,
        `Content` longtext CHARACTER SET utf8mb4 NOT NULL,
        `UpdatedAt` datetime(6) NOT NULL,
        CONSTRAINT `PK_OperationDocuments` PRIMARY KEY (`Id`)
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260614065302_AddOperationDocuments', '9.0.7');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260614104154_AddOperationDocumentComments') THEN

    CREATE TABLE `OperationDocumentComments` (
        `Id` int NOT NULL AUTO_INCREMENT,
        `DocumentType` varchar(100) CHARACTER SET utf8mb4 NOT NULL,
        `Comment` longtext CHARACTER SET utf8mb4 NOT NULL,
        `CreatedAt` datetime(6) NOT NULL,
        CONSTRAINT `PK_OperationDocumentComments` PRIMARY KEY (`Id`)
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260614104154_AddOperationDocumentComments', '9.0.7');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260614111146_MakeOperationDocumentCommentDependent') THEN

    ALTER TABLE `OperationDocumentComments` ADD `OperationDocumentId` int NULL;
...
BEGIN
    ...
    DELETE FROM OperationDocumentComments WHERE OperationDocumentId IS NULL;
...
BEGIN
    ...
    ALTER TABLE `OperationDocumentComments` DROP COLUMN `DocumentType`;
...
BEGIN
    ...
    ALTER TABLE `OperationDocumentComments` MODIFY COLUMN `OperationDocumentId` int NOT NULL;
...
BEGIN
    ...
    CREATE INDEX `IX_OperationDocumentComments_OperationDocumentId` ON `OperationDocumentComments` (`OperationDocumentId`);
...
BEGIN
    ...
    ALTER TABLE `OperationDocumentComments` ADD CONSTRAINT `FK_OperationDocumentComments_OperationDocuments_OperationDocumen` FOREIGN KEY (`OperationDocumentId`) REFERENCES `OperationDocuments` (`Id`) ON DELETE CASCADE;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260614111146_MakeOperationDocumentCommentDependent', '9.0.7');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260614145903_AddOperationDocumentAuthorFields') THEN

    ALTER TABLE `OperationDocuments` ADD `AuthorName` varchar(100) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `OperationDocuments` ADD `AuthorUserName` varchar(256) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `OperationDocumentComments` ADD `AuthorName` varchar(100) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `OperationDocumentComments` ADD `AuthorUserName` varchar(256) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260614145903_AddOperationDocumentAuthorFields', '9.0.7');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260614162018_AddOperationDocumentAttachments') THEN

    CREATE TABLE `OperationDocumentAttachments` (
        `Id` int NOT NULL AUTO_INCREMENT,
        `OperationDocumentId` int NOT NULL,
        `RelativePath` varchar(260) CHARACTER SET utf8mb4 NOT NULL,
        ...
        CONSTRAINT `PK_OperationDocumentAttachments` PRIMARY KEY (`Id`),
        CONSTRAINT `FK_OperationDocumentAttachments_OperationDocuments_OperationDoc~` FOREIGN KEY (`OperationDocumentId`) REFERENCES `OperationDocuments` (`Id`) ON DELETE CASCADE
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    CREATE INDEX `IX_OperationDocumentAttachments_OperationDocumentId` ON `OperationDocumentAttachments` (`OperationDocumentId`);
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260614162018_AddOperationDocumentAttachments', '9.0.7');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260901060126_AddTitleToOperationDocuments') THEN

    ALTER TABLE `OperationDocuments` ADD `Title` longtext CHARACTER SET utf8mb4 NOT NULL;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260901060126_AddTitleToOperationDocuments', '9.0.7');
